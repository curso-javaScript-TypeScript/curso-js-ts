...
// Positive lookahead (frases completas que tem 'active')
// console.log(lookahead.match(/.+[^in]active$/gim));

// Positive lookahead (frases que tem active; excluindo-a)
// console.log(lookahead.match(/.+(?=[^in]active)/gim));

// Positive lookahead (frases que tem inactive; excluindo-a)
