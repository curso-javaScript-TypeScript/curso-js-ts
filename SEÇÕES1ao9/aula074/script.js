...
*/
// Constructor Function (Função Construtora) -> molde (classe)
function Pessoa(nome, sobrenome) {
  this.nome = nome;
  this.sobrenome = sobrenome;
  // this.nomeCompleto = () => 'Original, o outro é o normal: ' + this.nome + ' ' + this.sobrenome;
}
...
// Pessoa.prototype.entendendo = 'prototype';

// instanciação -> objetos que vêm da Função
const pessoa1 = new Pessoa('Magno', 'V Gomes'); // <- Pessoa = Função construtora
const pessoa2 = new Pessoa('Neusa', 'da Silva'); // <- Pessoa = Função construtora
